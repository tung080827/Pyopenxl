...
sr_w = Tkentry(canvas=my_canvas,x=400,y=120,w=90,guide_text=srw_g)
shrink_e = Tkentry(canvas=my_canvas,x=400,y=155,w=90,guide_text=shrink_g)
p_excel = Tkentry(canvas=my_canvas,x=150,y=40,w=700,guide_text=excel_g, justify='left')
v_sheet = Tkentry(canvas=my_canvas,x=150,y=80,w=340,guide_text=v_sheet_g)
v_start = Tkentry(canvas=my_canvas,x=150,y=230,w=140,guide_text=v_start_g)
v_end = Tkentry(canvas=my_canvas,x=300,y=230,w=140,guide_text=v_end_g)
v_X = Tkentry(canvas=my_canvas,x=150,y=270,w=140,guide_text=v_X_g)
v_Y = Tkentry(canvas=my_canvas,x=300,y=270,w=140,guide_text=v_Y_g)
die_tb_o_sheet = Tkentry(canvas=my_canvas,x=600,y=195,w=290,guide_text=die_tb_o_sheet_g)

die_tb_o_name = Tkentry(canvas=my_canvas,x=600,y=230,w=140,guide_text=die_tb_o_name_g)
die_tb_o_loc = Tkentry(canvas=my_canvas,x=600,y=270,w=140,guide_text=die_tb_o_loc_g)

die_tbsr_o_name = Tkentry(canvas=my_canvas,x=750,y=230,w=140,guide_text=die_tbsr_o_name_g)
die_tbsr_o_loc = Tkentry(canvas=my_canvas,x=750,y=270,w=140,guide_text=die_tbsr_o_loc_g)
dm_v_cor1_start = Tkentry(canvas=my_canvas,x=150,y=350,w=140,guide_text=dummystart_g)
dm_v_cor1_end = Tkentry(canvas=my_canvas,x=300,y=350,w=140,guide_text=dummyend_g)
dm_v_cor1_X = Tkentry(canvas=my_canvas,x=150,y=380,w=140,guide_text=dummy_X_g)
dm_v_cor1_Y = Tkentry(canvas=my_canvas,x=300,y=380,w=140,guide_text=dummy_Y_g)

dm_v_cor2_start = Tkentry(canvas=my_canvas,x=600,y=350,w=140,guide_text=dummystart_g)
dm_v_cor2_end = Tkentry(canvas=my_canvas,x=750,y=350,w=140,guide_text=dummyend_g)
dm_v_cor2_X = Tkentry(canvas=my_canvas,x=600,y=380,w=140,guide_text=dummy_X_g)
dm_v_cor2_Y = Tkentry(canvas=my_canvas,x=750,y=380,w=140,guide_text=dummy_Y_g)

dm_v_cor3_start = Tkentry(canvas=my_canvas,x=150,y=430,w=140,guide_text=dummystart_g)
dm_v_cor3_end = Tkentry(canvas=my_canvas,x=300,y=430,w=140,guide_text=dummyend_g)
dm_v_cor3_X = Tkentry(canvas=my_canvas,x=150,y=460,w=140,guide_text=dummy_X_g)
dm_v_cor3_Y = Tkentry(canvas=my_canvas,x=300,y=460,w=140,guide_text=dummy_Y_g)

dm_v_cor4_start = Tkentry(canvas=my_canvas,x=600,y=430,w=140,guide_text=dummystart_g)
dm_v_cor4_end = Tkentry(canvas=my_canvas,x=750,y=430,w=140,guide_text=dummyend_g)
dm_v_cor4_X = Tkentry(canvas=my_canvas,x=600,y=460,w=140,guide_text=dummy_X_g)
dm_v_cor4_Y = Tkentry(canvas=my_canvas,x=750,y=460,w=140,guide_text=dummy_Y_g)

chip_size_x = Tkentry(canvas=my_canvas,x=150,y=560,w=170,guide_text=chip_size_x_g)
chip_size_y = Tkentry(canvas=my_canvas,x=340,y=560,w=170,guide_text=chip_size_y_g)
int_sheet = Tkentry(canvas=my_canvas,x=530,y=560,w=170,guide_text=int_sheet_g)
int_tb_o_loc = Tkentry(canvas=my_canvas,x=720,y=560,w=170,guide_text=int_tb_o_loc_g)
int_chip_L_name = Tkentry(canvas=my_canvas,x=150,y=630,w=360,guide_text=chipL_name_g)
int_chip_R_name = Tkentry(canvas=my_canvas,x=530,y=630,w=360,guide_text=chipR_name_g)
int_chip_L_xoffset = Tkentry(canvas=my_canvas,x=150,y=670,w=360,guide_text=int_chip_L_xoffset_g)
int_chip_R_xoffset = Tkentry(canvas=my_canvas,x=530,y=670,w=360,guide_text=int_chip_R_xoffset_g)
int_chip_L_yoffset = Tkentry(canvas=my_canvas,x=150,y=710,w=360,guide_text=int_chip_L_yoffset_g)
int_chip_R_yoffset = Tkentry(canvas=my_canvas,x=530,y=710,w=360,guide_text=int_chip_R_yoffset_g)
